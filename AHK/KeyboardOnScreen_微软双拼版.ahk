...
Gui, Add, Button, %k_Position%, Q,q iu
Gui, Add, Button, %k_Position%, W,ia ua
Gui, Add, Button, %k_Position%, E,e
Gui, Add, Button, %k_Position%, R,r er uan
Gui, Add, Button, %k_Position%, T,t ue
Gui, Add, Button, %k_Position%, Y,y uai v
Gui, Add, Button, %k_Position%, U,sh u
Gui, Add, Button, %k_Position%, I,ch i
Gui, Add, Button, %k_Position%, O,' o uo
Gui, Add, Button, %k_Position%, P,p un
;
;Gui, Add, Button, %k_Position%, [
;Gui, Add, Button, %k_Position%, ]
;Gui, Add, Button, %k_Position%, \

Gui, Add, Button, xs+%k_KeyWidthHalf% y+%k_KeyMargin% %k_KeySize%, A,a
Gui, Add, Button, %k_Position%, S,s iong ong
Gui, Add, Button, %k_Position%, D,d iang uang
Gui, Add, Button, %k_Position%, F,f en
Gui, Add, Button, %k_Position%, G,g eng
Gui, Add, Button, %k_Position%, H,h ang
Gui, Add, Button, %k_Position%, J,j an
Gui, Add, Button, %k_Position%, K,k ao
Gui, Add, Button, %k_Position%, L,l ai
Gui, Add, Button, %k_Position%, `;,ing
;Gui, Add, Button, %k_Position%, '
...
Gui, Add, Button, %k_Position%, Z,z ei
Gui, Add, Button, %k_Position%, X,x ie
Gui, Add, Button, %k_Position%, C,c iao
Gui, Add, Button, %k_Position%, V,zh ui
Gui, Add, Button, %k_Position%, B,b ou
Gui, Add, Button, %k_Position%, N,n in
Gui, Add, Button, %k_Position%, M,m ian
;Gui, Add, Button, %k_Position%, `,
;Gui, Add, Button, %k_Position%, .
;Gui, Add, Button, %k_Position%, /
