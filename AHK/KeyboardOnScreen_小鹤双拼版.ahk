...
Gui, Add, Button, %k_Position%, W,ei
Gui, Add, Button, %k_Position%, E,e
Gui, Add, Button, %k_Position%, R,r uan
Gui, Add, Button, %k_Position%, T,t ue ve
Gui, Add, Button, %k_Position%, Y,y un
Gui, Add, Button, %k_Position%, U,sh u
Gui, Add, Button, %k_Position%, I,ch i
Gui, Add, Button, %k_Position%, O,o uo
Gui, Add, Button, %k_Position%, P,p ie
;
;Gui, Add, Button, %k_Position%, [
;Gui, Add, Button, %k_Position%, ]
;Gui, Add, Button, %k_Position%, \
...
Gui, Add, Button, %k_Position%, D,d ai
...
Gui, Add, Button, %k_Position%, K,k uai ing 
Gui, Add, Button, %k_Position%, L,l uang iang 
;Gui, Add, Button, %k_Position%, `;
;Gui, Add, Button, %k_Position%, '
...
Gui, Add, Button, %k_Position%, Z,z ou
Gui, Add, Button, %k_Position%, X,x ua ia
Gui, Add, Button, %k_Position%, C,c ao
Gui, Add, Button, %k_Position%, V,zh ui v
Gui, Add, Button, %k_Position%, B,b in
Gui, Add, Button, %k_Position%, N,n iao
